...
const OwnershipStep: React.FC = () => {
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center w-full">
      <p className="text-gray-400 mb-8 text-xs px-20 w-[40%] mt-8 text-justify">Please carefully complete the information below and make sure that it is accurate including a complete address with city/state/zip and information about the control person and all beneficial owner(s) owning more than 20% of the company. If this information is inaccurate or incomplete, this could result in delay or denial of your application.</p>
