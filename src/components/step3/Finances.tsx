      ...
      <div className="flex items-start justify-between w-full mb-8 gap-4" >
        <div className="flex items-start flex-1 min-w-0 gap-2">
          ...
          <div className="relative group flex-shrink-0 mt-0.5">
            ...
            <div className="absolute bottom-full right-0 mb-2 px-3 py-2 text-xs text-white bg-gray-800 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap z-50">
