...
const ERROR_MESSAGES = {
  ...
  MISSING_ENV_FORMDATA: 'Missing env vars for sendFormData: REACT_APP_HUBSPOT_COMPANY_ID, REACT_APP_HUBSPOT_DEAL_ID, and/or REACT_APP_HUBSPOT_CONTACT_ID.',
  MISSING_ENV_UPLOAD: 'Missing env vars for file upload: REACT_APP_HUBSPOT_COMPANY_ID, REACT_APP_HUBSPOT_DEAL_ID, and/or REACT_APP_HUBSPOT_CONTACT_ID.',
